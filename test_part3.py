...
for each in board.get_words():
	print(each)
print("== Test get_words [顺序是重要的]==")
word_list = ['ba','ba','eo','ez','fuh','ha','happy','he','hi','idk','io','la','la','ok','omfg','ops','peep','test','wash','we','wow']
...
for each in board.get_words():
	print(each)
print("== Test get_words [顺序是重要的]==")
word_list = ['ez','fuh','ha','happy','idk','ok','omfg','ops','peep','test','wash','we','wow']
for each in word_list:
	print(each)
count = 0
wrong_list = []
