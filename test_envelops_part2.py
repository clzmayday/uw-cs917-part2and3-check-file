...
if not cir1.envelops(sq):
    ...
    print("圆里面包含正方形（左上出界）错误")

sq = part2.Square(part2.Point(0,4), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（右上出界）")
else:
    print("圆里面包含正方形（右上出界）错误")

sq = part2.Square(part2.Point(-4,0), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左下出界）")
else:
    print("圆里面包含正方形（左下出界）错误")

sq = part2.Square(part2.Point(0,0), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（右下出界）")
else:
    print("圆里面包含正方形（右下出界）错误")

sq = part2.Square(part2.Point(-1,5), 2)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左上右上出界）")
else:
    print("圆里面包含正方形（同中心,左上右上出界）错误")

sq = part2.Square(part2.Point(-5,1), 2)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左上左下出界）")
else:
    print("圆里面包含正方形（左上左下出界）错误")
    
sq = part2.Square(part2.Point(4,1), 2)
if not cir1.envelops(sq):
    print("圆里面包含正方形（右上右下出界）")
else:
    print("圆里面包含正方形（右上右下出界）错误")

sq = part2.Square(part2.Point(-1,-4), 2)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左下右下出界）")
else:
    print("圆里面包含正方形（左下右下出界）错误")

sq = part2.Square(part2.Point(-7,7), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左上左下右上出界）")
else:
    print("圆里面包含正方形（左上左下右上出界）错误")
    
sq = part2.Square(part2.Point(3,7), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左上右上右下出界）")
else:
    print("圆里面包含正方形（左上右上右下出界）错误")

sq = part2.Square(part2.Point(3,-3), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左下右上右下出界）")
else:
    print("圆里面包含正方形（左下右上右下出界）错误")

sq = part2.Square(part2.Point(-7,-3), 4)
if not cir1.envelops(sq):
    print("圆里面包含正方形（左上左下右下出界）")
else:
    print("圆里面包含正方形（左下左上右下出界）错误")
